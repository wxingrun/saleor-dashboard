...
describe("validateChannelFormData", () => {
  ...
  it("should return no error when slug contains illegal characters (uppercase, spaces, special symbols)", () => {
    // Arrange
    const data: FormData = {
      ...validFormData,
      slug: "TEST Channel!@#$",
  ...
  it("should return REQUIRED error when currencyCode is empty string", () => {
    // Arrange
    const data: FormData = {
      ...validFormData,
      currencyCode: "",
  ...
  it("should return no error when defaultCountry is a valid ISO 3166-1 alpha-2 code", () => {
    // Arrange
    const data: FormData = {
      ...validFormData,
  ...
  it("should return REQUIRED error when slug is empty string", () => {
    // Arrange
    const data: FormData = {
      ...validFormData,
      slug: "",
  ...
  it("should return no error when slug exceeds 50 characters", () => {
    // Arrange
    const data: FormData = {
      ...validFormData,
      slug: "a".repeat(51),
