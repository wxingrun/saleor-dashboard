...
COPY src/attributes/queries.ts src/attributes/queries.ts
COPY src/attributes/mutations.ts src/attributes/mutations.ts
...
RUN mkdir -p /tmp/generated-main && cp src/graphql/*.generated.ts /tmp/generated-main/

COPY src/ src/
RUN cp /tmp/generated-main/*.generated.ts src/graphql/
